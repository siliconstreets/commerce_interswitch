...
TROUBLESHOOTING
---------------
  * If the inclusion of the Interswitch charge is enabled then Payment checkout
  pane must come before the Review checkout pane. This can be done by
  rearranging the panes in Drupal Commerce's checkout configuration page at
